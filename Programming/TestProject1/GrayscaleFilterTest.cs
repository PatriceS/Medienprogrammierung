...
namespace TestProject1
{
    ...
    public class GrayscaleFilterTest
    {
        ...
        public void GrayscaleFilterConstructorTest()
        {
            ...
            GrayscaleFilter target = new GrayscaleFilter(b, Scan0, stride, height_start, height_end, thInfo);
        ...
        public void performTest()
        {
            ...
            int height_end = 0; // TODO: Passenden Wert initialisieren
            ThreadHandler thInfo = null; // TODO: Passenden Wert initialisieren
            GrayscaleFilter target = new GrayscaleFilter(b, Scan0, stride, height_start, height_end, thInfo); // TODO: Passenden Wert initialisieren
            target.perform();
