...
namespace TestProject1
{
    ...
    /// <summary>
    ///Dies ist eine Testklasse für "SepiaFilterTest" und soll
    ///alle SepiaFilterTest Komponententests enthalten.
    ///</summary>
    [TestClass()]
    public class SepiaFilterTest
    {
        ...
        public void performTest()
        {
            ...
            SepiaFilter target = new SepiaFilter(b, Scan0, stride, height_start, height_end, thInfo); // TODO: Passenden Wert initialisieren
            target.perform();
            
        }

        /// <summary>
        ///Ein Test für "SepiaFilter-Konstruktor"
        ///</summary>
        [TestMethod()]
        public void SepiaFilterConstructorTest()
        {
            ...
            int height_end = 0; // TODO: Passenden Wert initialisieren
            ThreadHandler thInfo = null; // TODO: Passenden Wert initialisieren
            SepiaFilter target = new SepiaFilter(b, Scan0, stride, height_start, height_end, thInfo);
